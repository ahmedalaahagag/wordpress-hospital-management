	...
	$('#birth_date').datepicker({
	 ...
	 if($active_tab == 'addreceptionist')
	 {
       ...
       <div class="panel-body">
			...
			<div class="col-sm-offset-2 col-sm-8">
                     <div id="upload_user_avatar_preview" >
	                     <?php if($edit) 
	                     	...
	                     	{?>
	                     	<img alt="" src="<?php echo get_option( 'hmgt_support_thumb' ); ?>">
	                     	<?php }
	                     	else {
	                     		?>
		...
		<div class="col-sm-offset-2 col-sm-8">
        	<input type="submit" value="<?php if($edit){ _e('Save Support Staff','hospital_mgt'); }else{ _e('Add Support Staff','hospital_mgt');}?>" name="save_receptionist" class="btn btn-success"/>
        </div>
        </form>
        </div>
