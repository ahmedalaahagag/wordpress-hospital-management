...
$(document).ready(function() {
	$('#laboratorist_form').validationEngine();
	...
	<div class="form-group">
			...
			<div class="col-sm-offset-2 col-sm-8">
                     <div id="upload_user_avatar_preview" >
	                     <?php if($edit) 
	                     	...
	                     	{?>
	                     	<img alt="" src="<?php echo get_option( 'hmgt_laboratorist_thumb' ) ?>">
	                     	<?php }
	                     	else {?>
		...
		<div class="col-sm-offset-2 col-sm-8">
        	<input type="submit" value="<?php if($edit){ _e('Save Laboratorist','hospital_mgt'); }else{ _e('Add Laboratorist','hospital_mgt');}?>" name="save_laboratorist" class="btn btn-success"/>
        </div>
        </form>
        </div>
