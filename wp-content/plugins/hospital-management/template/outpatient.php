       ...
       <table id="outpatient_list" class="display dataTable " cellspacing="0"	>
			...
			<th style="width: 50px;height:50px;"><?php  _e( 'Photo', 'hospital_mgt' ) ;?></th>
			 <th><?php _e( 'Patient Name', 'hospital_mgt' ) ;?></th>
			   ...
			   <th><?php _e( 'Patient Email', 'hospital_mgt' ) ;?></th>
			   <th><?php _e( 'Patient Phone Number', 'hospital_mgt' ) ;?></th>
			   			   <th><?php _e( ' ', ' ' ) ;?></th>
		...
		$patientdata=get_users($get_patient);
		 ...
		 ?>
            <tr>
				...
				?></td>
                <td class="name"><a href="?dashboard=user&page=outpatient&tab=addoutpatient&action=edit&outpatient_id=<?php echo $retrieved_data->ID;?>"><?php echo $retrieved_data->first_name.$retrieved_data->middle_name; ?></a></td>
                <td class="patient_id">
				<?php
                ...
                <td class="blood_group"><?php echo get_user_meta($uid, 'blood_group', true);?></td>
				...
				<a href="?dashboard=user&page=outpatient&tab=outpatientlist&action=delete&outpatient_id=<?php echo $retrieved_data->ID;?>" class="btn btn-danger"> <?php _e('Remove', 'hospital_mgt' ) ;?></a>
                <?php } ?>
                </td>
